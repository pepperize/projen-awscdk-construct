...
| <code><a href="#@pepperize/projen-awscdk-construct.AwsCdkConstructLibrary.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="@pepperize/projen-awscdk-construct.AwsCdkConstructLibrary.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@pepperize/projen-awscdk-construct.AwsCdkConstructLibrary.with.parameter.mixins"></a>
